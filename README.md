...
function RadientPaid:Window(text,maincolor)
   ...
   return ServerHold
	...
	local win = RadientPaid:Window("Blox Fruit Update 17 Part2 Credit LNhub ")
	
	local serv = win:Server("CVE HUB", "")
...
local function UpdateTime()
   ...
   game:GetService("CoreGui").FuckyouBicth.MainFrame.TopFrame.TopFrameHolder.ServersHolder.ServerFrame.ChannelContentFrame.ChannelHolder.Label.LabelTitle.Text = ("Time \n".."Server Time |".." Hour : "..Hour.." Minute : "..Minute.." Second : "..Second.." \nTime | "..os.date("%H")..":"..os.date("%M")..":"..os.date("%S"))
end
...
spawn(function()
   pcall(function()
      while wait() do
         if _G.Auto_Bone == true then
            spawn(function()
               while wait() do
            if _G.Auto_Bone then
              pcall(function()
              for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
               Distance = (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.HumanoidRootPart.Position).Magnitude
...
Wapon = {}
   ...
   setting:Toggle("Fast Attack", _G.FastAtttk, function(vu)
    _G.FastAtttk = vu
   end)
...
Raid:Toggle("Auto Awakener", _G.AutoAwakener,function(value)
   ...
   shop:Line()
   shop:Label("CommingSoon")
   
   shop:Toggle("Auto Buy LegendarySword",_G.AutoBLS,function(vu)
   _G.KillAura = vu
   end)
   
   local player = serv:Channel("Players")
   player:Line()
   player:Label("ล่าค่าหัวไม")

   local misc = serv:Channel("Misc")
   misc:Line()
   misc:Label("For Scripter")

   misc:Button("Setclipboard pos", function()
    setclipboard(tostring(game.Players.LocalPlayer.Character.HumanoidRootPart.Position))
   end)
   misc:Button("Some X Hub", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/kickTh/SCRIPT-SOME-X-HUB/main/README.md")()
end)

   local hub = serv:Channel("Hub")

   hub:Button("MukuroHub", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/Zyrex-X/MukuroHubAndriond/main/README.md")()
end)

   hub:Button("UI Toggles MukuroHub", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/Zyrex-X/uitog/main/README.md")()
   end)

   hub:Button("Some X Hub", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/kickTh/SCRIPT-SOME-X-HUB/main/README.md")()
   end)

   hub:Button("Netna Hub", function()
   ...
   hub:Button("Maru X Hub", function()
    loadstring(game:HttpGet"https://pastebin.com/raw/mUw5xC3J")()
   end)

   hub:Button("Dino Hub", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/natoppo044/modzcaster/main/dinobf.lua")()
   end)

   hub:Button("Saza Hub", function()
    loadstring(game:HttpGet"https://www.scriptblox.com/raw/SAZA-HUB_496")()
   end)

   hub:Button("Fusion Hub", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/SHAREHACK/script/main/fusion1")()
   end)

   hub:Button("Power X Hub", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/PowerxCANDYYY/BFFREE/main/POWERX.lua")()
   end)

   hub:Button("Ripper Hub", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/hajibeza/RIPPER-HUB/main/BFMobile.lua")()
   end)

   hub:Button("สคริปเหี้ยไรนี่5555", function()
    loadstring(game:HttpGet"https://raw.githubusercontent.com/Gohan9k/BLACKTRAP/main/GOHANSSJ3")()
   end)

   hub:Button("Ren Hub", function()
    getgenv().keys = "Ren-IQVHIN-Y9N3MY"
    getgenv().Discordid = "861809193501196309"
    loadstring(game:HtMainGet('htMains://raw.githubusercontent.com/RenHubb/Script/main/scriptmobile.lua'))()
   end)

   hub:Button("Idk hub", function()
    loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/MynameIsDoit/MonkeyHitBox/main/HEEHITBOX"))()
   end)

   hub:Button("MaruHub", function()
    -- แนะนำใช้โลก3
-- ห้ามอัพสายอื่นนอกจากปืนไม่งั้นจะล่าไม่ได้
-- ห้ามใช้ผลโลเกีย

-- Recommended Third Sea
-- Do not use all logia fruits
-- Gun Stat Only!
_G.AutoFarmBounty = true
loadstring(game:HtMainGet("htMains://raw.githubusercontent.com/xshiba/Free-Script/main/Bounty.lua"))()
end)
...
spawn(function()
   ...
   spawn(function()
      while wait() do
         pcall(function()
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                       if _G.AutoFarmLv or _G.Auto_Bone  and MagnetActive and Magnet then
...
spawn(function()
    ...
    game:GetService("RunService").Stepped:Connect(function()
        if _G.AutoFarmLv or _G.nextisland or _G.Auto_Bone then
...
spawn(function()
    pcall(function()
    while wait() do
    if _G.AutoFarmLv or _G.Auto_Bone then
    ...
    spawn(function()
        pcall(function()
            while game:GetService("RunService").Heartbeat:wait() do
                if _G.AutoFarmLv or _G.AutoDungeonFarm or _G.Auto_Bone then
...
spawn(function()
    ...
    local kuy = up[2]
    spawn(function()
        kuy.activeController.timeToNextAttack = 0
        kuy.activeController.timeToNextBlock = 0
        kuy.activeController.increment = 3
        kuy.activeController.hitboxMagnitude = 60
        kuy.activeController.focusStart = 0
        kuy.activeController.currentAttackTrack = 0
        kuy.activeController.hitboxMagnitude = 60
        kuy.activeController:attack()
    end)
